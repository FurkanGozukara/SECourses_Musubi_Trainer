...
def initialize_ui_interface(config_manager, headless, release_info, readme_content):
    ...
    with ui_interface:
        ...
        gr.Markdown("# SECourses Musubi Trainer V10 : [https://www.patreon.com/posts/137551634](https://www.patreon.com/posts/137551634)")
...
def UI(**kwargs):
    ...
    release_info = "v10.0"  # Hardcoded version since pyproject.toml is not needed
