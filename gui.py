...
def initialize_ui_interface(config_manager, headless, release_info, readme_content):
    ...
    ui_interface = gr.Blocks(css=css, title="SECourses Musubi Trainer V21.7", theme=gr.themes.Soft())
    with ui_interface:
        # Add title with Patreon link
        gr.Markdown("# SECourses Musubi Trainer V21.7 : [https://www.patreon.com/posts/137551634](https://www.patreon.com/posts/137551634)")
