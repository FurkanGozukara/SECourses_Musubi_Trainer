...
class TabConfigManager:
    ...
    def get_config_for_tab(self, tab_name: str) -> GUIConfig:
        ...
        if self.user_loaded_config and not self.config_file_path.endswith((
            "qwen_image_defaults.toml",
            "wan_defaults.toml",
            "flux_defaults.toml",
            "zimage_defaults.toml",
            "ideogram4_defaults.toml",
            "krea2_defaults.toml",
            "ltx2_defaults.toml",
            "minimax_h3_defaults.toml",
    ...
    def _load_tab_defaults(self, tab_name: str) -> GUIConfig:
        ...
        default_files = {
            ...
            "flux": "flux_defaults.toml",
            "zimage": "zimage_defaults.toml",
            "ideogram4": "ideogram4_defaults.toml",
            "krea2": "krea2_defaults.toml",
            "ltx2": "ltx2_defaults.toml",
            "minimax_h3": "minimax_h3_defaults.toml",
            "musubi_tuner": "musubi_tuner_defaults.toml",
            "image_captioning": "image_captioning_defaults.toml",
            "model_quantizer": "model_quantizer_defaults.toml",
